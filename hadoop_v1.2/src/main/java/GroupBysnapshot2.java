...
public class GroupBysnapshot2 {
    private static final String INPUT_PATH = "input-snapshot/";
    private static final String OUTPUT_PATH = "output/snapshot2-";
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, DoubleWritable>  {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException, NumberFormatException{
            ...
            context.write(new Text(campaign),  new DoubleWritable(conv));
    ...
    public static class Reduce extends Reducer<Text, DoubleWritable, Text, DoubleWritable> {
        ...
        public void reduce(Text key, Iterable<DoubleWritable> values, Context context)
            ...
            for (DoubleWritable val : values)
                sum += val.get();
            //faire la somme des conv par campagne :
