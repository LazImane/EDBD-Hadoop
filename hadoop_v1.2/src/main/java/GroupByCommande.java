...
public class GroupByCommande {
    ...
    private static final String OUTPUT_PATH = "output/groupBy-commande";
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, Text>{
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            String quantite = fields[fields.length-3];
            /*Exercice 2*/
            ...
            /*Exercice 3.3*/
            context.write(new Text(orderId), new Text(quantite + "," + produitId));
    ...
    public static class Reduce extends Reducer<Text, Text, Text, Text> {
        ...
        public void reduce(Text key, Iterable<Text> values, Context context)
            ...
            java.util.HashSet<String> produits = new java.util.HashSet<>();
            for (Text val : values) {
                String v = val.toString();
                String[] parts = v.split(",");
                double quantite = Double.parseDouble(parts[0]);
                String produitId = parts[1];
                produits.add(produitId);
                totalQuantity += quantite;
            }
            context.write(key, new Text(produits.size()+"|"+totalQuantity));
    ...
    public static void main(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "GroupByCommande");
